...
function Switch(props) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: `${styles$7.switch} ${props.className}`, id: props.id ?? "", type: "button", role: "switch", ...props.onClick ? {
    onClick: props.onClick
  } : {}, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$7.check, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$7.icon, children: props.children }) }) });
}
function SwitchAppearance() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Switch, { onClick: toggle, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$7.sun, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "i-carbon-sun", w: "full", h: "full" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$7.moon, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "i-carbon-moon", w: "full", h: "full" }) })
  ] });
}
...
function MenuItem({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-medium mx-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: styles$6.link, href: item.link, children: item.text }) });
}
function Nav() {
  var _a;
  const {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { fixed: "~", pos: "t-0 l-0", w: "full", z: "10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { flex: "~", items: "center", justify: "between", className: `h-14 divider-bottom ${styles$6.nav}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/", hover: "opacity-60", className: "w-full h-full text-1rem font-semibold flex items-center", children: "MudeDOC" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { flex: "~", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { flex: "~", children: nav2.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(MenuItem, { item }, item.text)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { before: "menu-item-before", flex: "~", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SwitchAppearance, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$6.socialLinkIcon, before: "menu-item-before", children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "i-carbon-logo-github w-5 h-5 fill-current" }) }) })
    ] })
  ] }) });
}
...
function Link(props) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href, target, rel, className: `${styles$5.link} ${className}`, children });
}
...
function HomeHero(props) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { m: "auto", p: "t-20 x-16 b-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { flex: "~", className: "max-w-1152px", m: "auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { text: "left", flex: "~ col", className: "max-w-592px", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { font: "bold", text: "6xl", className: "max-w-576px", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$3.clip, children: hero.name }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { text: "6xl", font: "bold", className: "max-w-576px", children: hero.text }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { p: "t-3", text: "2xl text-2", font: "medium", className: "whitespace-pre-wrap max-w-576px", children: hero.tagline }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { flex: "~ wrap", justify: "start", p: "t-8", children: hero.actions.map((action) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { p: "1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "a", text: action.text, href: action.link, theme: action.theme }) }, action.link)) })
    ] }),
    hero.image && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { w: "max-96", h: "max-96", flex: "center", m: "auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: hero.image.src, alt: hero.image.alt }) })
  ] }) });
}
function HomeFeature(props) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-1152px", m: "auto", flex: "~ wrap", justify: "between", children: props.features.map((feature) => {
    const {
      icon: icon2,
      title: title2,
      details
    } = feature;
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { border: "rounded-md", p: "r-4 b-4", w: "1/3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { bg: "bg-soft", border: "~ bg-soft solid rounded-xl", p: "6", h: "full", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { bg: "gray-light-4 dark:bg-white", border: "rounded-md", className: "mb-5 w-12 h-12 text-3xl flex-center", children: icon2 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { font: "bold", children: title2 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { text: "sm text-2", font: "medium", className: "pt-2 leading-6", children: details })
    ] }) }, title2);
  }) });
}
function HomeLayout() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(HomeHero, { hero: frontmatter.hero }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(HomeFeature, { features: frontmatter.features })
  ] });
}
...
function Sidebar(props) {
  ...
  const renderGroupItem = (item) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ml: "5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { p: "1", block: "~", text: "sm", "font-medium": "~", className: `${active ? "text-brand" : "text-text-2"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { href: item.link, children: item.text }) }) });
  };
  const renderGroup = (item) => {
    var _a;
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { block: "~", "not-first": "divider-top mt-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { flex: "~", justify: "between", items: "center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { m: "t-3 b-2", text: "1rem text-1", font: "bold", children: item.text }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { mb: "1", children: (_a = item.items) == null ? void 0 : _a.map((item2) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: renderGroupItem(item2) }, item2.link)) })
    ] }, item.text);
  };
...
function Aside(props) {
  ...
  const renderHeader = (header) => {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: `#${header.id}`, className: "block leading-7 text-text-2 hover:text-text-1", transition: "color duration-300", style: {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { flex: "~ col 1", style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "leading-7": "~", text: "13px", font: "semibold", children: "ON THIS PAGE" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { relative: "~", children: headers.map(renderHeader) }) })
  ] }) }) });
}
function usePrevNextPage() {
  ...
  const sidebar2 = ((_a = siteData2 == null ? void 0 : siteData2.themeConfig) == null ? void 0 : _a.sidebar) || {};
  const flattenTitles = [];
...
function DocFooter() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { mt: "8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { flex: "~", gap: "2", "divider-top": "~", pt: "6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { flex: "~ col", className: styles$1.prev, children: prevPage && /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: prevPage.link, className: styles$1.pagerLink, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$1.desc, children: "上一页" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$1.title, children: prevPage.text })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { flex: "~ col", className: styles$1.next, children: nextPage && /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: nextPage.link, className: `${styles$1.pagerLink} ${styles$1.next}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$1.desc, children: "下一页" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$1.title, children: nextPage.text })
    ] }) })
  ] }) });
}
...
function DocLayout() {
  ...
  const sidebarData = ((_a = siteData2 == null ? void 0 : siteData2.themeConfig) == null ? void 0 : _a.sidebar) || {};
  const {
    pathname
  } = useLocation();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Sidebar, { sidebarData: matchedSidebar, pathname }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.content, flex: "~", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.docContent, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "musedoc-doc", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Content, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(DocFooter, {})
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.asideContainer, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Aside, { headers: toc, __island: "../../components/Aside!!ISLAND!!/Users/haohaiyou/Documents/learn/musecode/musedoc/src/theme-default/Layout/DocLayout/index.tsx" }) })
    ] })
  ] });
}
function NotFoundLayout() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { m: "auto t-50", p: "t-16 x-6 b-24 sm:t-24 x-8 b-40", text: "center", flex: "center col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { text: "6xl", font: "semibold", children: "404" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { pt: "3", text: "xl", font: "bold", className: "leading-5", children: "PAGE NOT FOUND" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { m: "t-6 x-auto b-4.5", w: "16", style: {
      height: "1px"
    }, bg: "divider-default" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { pt: "5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { "inline-block": "", border: "1px solid brand", rounded: "2xl", p: "y-1 x-4", text: "sm brand", "font-medium": "", transition: "border-color duration-300 color duration-300", hover: "border-color-brand-dark color-brand-dark", href: "/", "aria-label": "go to home", children: "Take me home" }) })
  ] });
}
function Layout() {
  ...
  const getContent = () => {
    if (pageType === "home") {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsx(DocLayout, {});
    } else {
      return /* @__PURE__ */ jsxRuntimeExports.jsx(NotFoundLayout, {});
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
...
async function renderInBrowser() {
  ...
  createRoot(containerEl).render(/* @__PURE__ */ jsxRuntimeExports.jsx(DataContext.Provider, { value: pageData, children: /* @__PURE__ */ jsxRuntimeExports.jsx(BrowserRouter, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(App, {}) }) }));
}
renderInBrowser();
export {
