...
function Index() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Hello, Index" });
}
function A() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Hello, A" });
}
function B() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Hello, B" });
}
const routes = [
  {
    path: "/guide",
  ...
  {
    path: "/guide/a",
    element: /* @__PURE__ */ jsxRuntimeExports.jsx(A, {})
  },
  {
    path: "/b",
    element: /* @__PURE__ */ jsxRuntimeExports.jsx(B, {})
  }
];
const Content = () => {
